        ...
        <div className="shadow two"></div>  */}
          ...
          <div className="bg-details">
            ...
            <p className="home-bg-content">
              Design thinking can also help create the right environment for
              real and much broader understanding of the voice of the customer.
              It helps move beyond the monologue of research and, if
              incorporating prototyping and testing, begins an ongoing process
              of dialogue with current and potential customers
            </p>
          </div>
        </div>
